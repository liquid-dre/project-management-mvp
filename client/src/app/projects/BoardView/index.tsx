...
const TaskColumn = ({
  ...
  return (
    // To use the DND we need a reference returned from the DND function above
    <div
      ref={(instance) => {
        drop(instance);
      }}
      className={`sl:py-4 rounded-lg py-2 xl:px-2 ${isOver ? "bigblue100" : ""}`}
    >
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4">
          ...
          <div className="flex items-center gap-1">
            <button className="flex h-6 w-5 items-center justify-center hover:bg-gray-200">
              <EllipsisVertical size={26} />
            </button>
            <button
              className="flex h-6 w-5 items-center justify-center rounded hover:bg-gray-200"
...
// Task Component
// Task Type is coming from the API file
type TaskProps = {
  task: TaskType;
};
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://pm-mvp-s3-images.s3.eu-north-1.amazonaws.com/${task.assignee.profilePictureUrl}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-mvp-s3-images.s3.eu-north-1.amazonaws.com/${task.author.profilePictureUrl}`}
